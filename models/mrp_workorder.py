...
class MrpWorkorder(models.Model):
    ...
    def _get_duration_expected(self, alternative_workcenter=False, ratio=1):
        ...
        if not self.operation_id:
            ...
            return (self.workcenter_id.time_start + self.workcenter_id.time_stop + duration_expected_working * ratio * 100.0 / self.workcenter_id.time_efficiency)*self.passes_nbr
        ...
        if alternative_workcenter:
            ...
            return (alternative_workcenter.time_start + alternative_workcenter.time_stop + alternative_wc_cycle_nb * duration_expected_working * 100.0 / alternative_workcenter.time_efficiency)*self.passes_nbr
        time_cycle = self.operation_id.time_cycle
        return (self.workcenter_id.time_start + self.workcenter_id.time_stop + cycle_number * time_cycle * 100.0 / self.workcenter_id.time_efficiency)*self.passes_nbr
